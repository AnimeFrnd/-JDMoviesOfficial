        ...
        if channels:  
            ...
            if btn:
                ...
                caption = (
                    ...
                    "ʏᴏᴜ ɴᴇᴇᴅ ᴛᴏ ᴊᴏɪɴ ᴏᴜʀ ᴄʜᴀɴɴᴇʟs ᴀɴᴅ\n"
                    "ᴛʜᴇɴ ᴄʟɪᴄᴋ ᴏɴ ʀᴇʟᴏᴀᴅ button ᴛᴏ ɢᴇᴛ ʏᴏᴜʀ \n"
                    "ʀᴇǫᴜᴇꜱᴛᴇᴅ ꜰɪʟᴇ. \n\n"
                    " కింద ఇచ్చిన 4 చానెల్స్ లో జాయిన్ అయ్యి\n"
                    "తరవాత Try Again క్లిక్ చేస్తే File📁 వస్తది..:)\n"
                    "🥰")
                await message.reply_photo(
