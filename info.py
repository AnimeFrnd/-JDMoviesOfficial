...
URL = "https://{}/".format(FQDN) if ON_HEROKU or NO_PORT else "https://cheap-sibyl-arya-anna-0edb7dbe.koyeb.app/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://cheap-sibyl-arya-anna-0edb7dbe.koyeb.app/".format(FQDN)
else:
    URL = "https://cheap-sibyl-arya-anna-0edb7dbe.koyeb.app/".format(FQDN)
